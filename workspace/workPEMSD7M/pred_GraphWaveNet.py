...
def testunmodel(name, mode, XS, YS, sample, scaler):
    ...
    model.load_state_dict(torch.load('/home/wuying/CODE/mymodel/2022/DL-Traff-Graph/results/表格的结果/pred_PEMS04_GraphWaveNet_bayesian_2210281121/GraphWaveNet.pt'))
