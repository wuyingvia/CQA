...
def V1_calModel(name, mode, XS, YS, scaler,cal_q):
    ...
    model.load_state_dict(torch.load('/home/wuying/CODE/mymodel/2022/DL-Traff-Graph/v3_save/'
                          'pred_PEMS04_GraphWaveNet_quantile_conformal_2210270122/GraphWaveNet.pt'))
