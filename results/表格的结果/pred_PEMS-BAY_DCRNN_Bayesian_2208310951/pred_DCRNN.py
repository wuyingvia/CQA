...
def getModel(name):
    ...
    model = DCRNN(device, prior_mu, prior_sigma, num_nodes=N_NODE, input_dim=CHANNEL, out_horizon=TIMESTEP_OUT, P=adj_mx).to(device)
    return model
...
def main():
    ...
    testunmodel(MODELNAME, 'test', testXS, testYS)
